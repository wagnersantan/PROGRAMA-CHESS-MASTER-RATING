    ...
    if 'partidas' in st.session_state:
        ...
        for partida in st.session_state.partidas:
            ...
            with col1:
                ...
                if st.button(f"Registrar resultado para {partida[0]} vs {partida[1]}", key=f"registrar_{partida[0]}_{partida[1]}"):  # Adicionada a chave única
            ...
            with col2:
                ...
                if st.button(f"Registrar resultado para {partida[1]} vs {partida[0]}", key=f"registrar_{partida[1]}_{partida[0]}"):  # Adicionada a chave única
        ...
        if st.button("Avançar para a Próxima Rodada", key="avancar_rodada"):  # Adicionada a chave única
